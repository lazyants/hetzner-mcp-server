...
export const REFERENCE_MD = [
  ...
  '## Base URLs',
  '',
  '- Cloud API: `https://api.hetzner.cloud/v1` (most domains).',
  '- Storage Box API: `https://api.hetzner.com/v1` (Storage Boxes domain only).',
  '',
  '## Authentication',
  '',
  'Bearer token via the `HETZNER_API_TOKEN` environment variable. Storage Box',
  'tools use `HETZNER_STORAGE_API_TOKEN` if set, otherwise fall back to',
  '`HETZNER_API_TOKEN`.',
  '',
  '## Rate limits',
  '',
  ...
  '| Storage Boxes¹ | `/storage_boxes` | `/storage_boxes/{id}/actions/{action}` |',
  '| Storage Box Snapshots¹ | `/storage_boxes/{id}/snapshots` | — |',
  '| Storage Box Subaccounts¹ | `/storage_boxes/{id}/subaccounts` | `/storage_boxes/{id}/subaccounts/{subaccount_id}/actions/{action}` |',
  '| Storage Box Types¹ | `/storage_box_types` | — |',
  '',
  '¹ Storage Box domains live on the `https://api.hetzner.com/v1` host.',
  '',
  '## Deprecations',
  '',
  'Hetzner deprecated `/datacenters` and `/datacenters/{id}` on 2026-06-02; they',
  'return HTTP 410 after 2026-10-01. Use `hetzner_list_server_types`',
  '(`locations[].available/recommended`) and `hetzner_list_locations` instead.',
  '',
  '## Conventions',
  '',
